...
export function PartnerSection() {
  return (
    <section className="py-14 lg:py-20 bg-white" id="partners">
      <div className="shell">
        <Reveal>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-6 gap-2 lg:gap-2.5">
          {PARTNERS.map((partner, i) => (
            ...
            >
              <div className="group min-h-[74px] lg:min-h-[112px] flex flex-col items-center justify-center gap-1.5 lg:gap-2.5 p-2 lg:p-3 rounded-lg border border-[#E5E7EB] bg-white hover:-translate-y-1 hover:border-[#ED7606]/30 hover:shadow-[0_8px_24px_rgba(0,0,0,.04)] transition-all duration-300">
