  ...
  return (
    <section className="py-16 lg:py-24 bg-white" id="company-video">
      <div className="shell">
        ...
        <Reveal delay={2}>
          <div className="relative max-w-4xl mx-auto aspect-video rounded-2xl overflow-hidden border border-[#E5E7EB] shadow-[0_8px_32px_rgba(0,0,0,.05)] bg-black">
            <a
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="flex items-center justify-center w-20 h-20 lg:w-24 lg:h-24 rounded-full bg-[#ED7606]/95 shadow-[0_18px_48px_rgba(237,118,6,.4)] group-hover:bg-[#ED7606] group-hover:scale-110 transition-all duration-300">
